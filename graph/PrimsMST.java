// The below algo uses normal heap , Classical Prims algo decreases the weight,but here we are iserting new weight node.
// classical version available at https://github.com/SOUVIGHO/TusharRoy-Repo/blob/master/src/com/interview/graph/PrimMST.java
// Time Complexisity O(ElogV) good for dense graph where E is huge , Kruskal is good for sparse graph where Vertex are more Edge are less.
class PrimsMST {
    // Prim Algorithm
